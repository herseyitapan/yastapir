			...
			ctx.replyWithMarkdown(
				trueTrim(`
					*🏁 Qaliblərin Siyahısı ⤵:*
					...
					❤️ Botun Rəsmi Kanalına Abunə Olmağı Unutmayaq. @VusalinBlogu
					🔄 /game - Bir daha?
				`)
			)
		} else {
	...
	if (top.length > 0) {
		ctx.replyWithMarkdown(
			...
			*⚡ Yay Sezonu Başladı. ⚡*
			...
			❤️ Bəzən yeni sərin botların dərc olunduğu müəllif kanalı @VusalinBlogu
			🔄 /game - Bir daha?
		`)
		)
	} else {
